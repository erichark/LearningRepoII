...
# 5. calculate growth over time of savings  (0.04% annually) and monthly savings (that div 12) as you save
# 6. main loop is while down payment >= savings
...
semi_annual_raise = 0 # percent raise every 6 months
